...
def celutter(souvenirs,threshold):
    pass

souvinirs1 = ["coin","alien egg","coin","coin","map","map","statue"]
threshold1 = 3

souvinirs2 = ["postrcard","postcard","postcard","sword"]
threshold = 2
["alien egg","map","map","map","statue"]
["sword"]
